...
class Magiccart_Magicmenu_Block_Menu extends Mage_Catalog_Block_Navigation
{
    ...
    public function drawMobileMenu()
    {
        if($this->hasData('drawMobileMenu')) return $this->getData('drawMobileMenu');
    ...
    { 
        ...
        if($html) $html = '<ul class="dl-submenu level'.($level -3).'">' .$html. '</ul>';
        return $html;
    }
